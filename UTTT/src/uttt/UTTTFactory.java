...
import uttt.game.PlayerImplentation;
import uttt.game.PlayerInterface;
import uttt.game.SimulatorImplementation;
...
public class UTTTFactory {
	...
	public static SimulatorInterface createSimulator() {
		// throw new UnsupportedOperationException("Not yet implemented");
		SimulatorImplementation simulator = new SimulatorImplementation();
		return simulator;
	}
	...
	public static PlayerInterface createHumanPlayer(Symbol symbol) {
		//throw new UnsupportedOperationException("Not yet implemented");
		PlayerInterface human =new PlayerImplentation(symbol);
		return human;
	}
